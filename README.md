...
Not yet scaffolded. First milestone is **B1**: an Expo dev build that installs on a real Android device via EAS internal distribution, with a disabled camera icon and nothing else. That proves the whole distribution chain before any feature exists.
